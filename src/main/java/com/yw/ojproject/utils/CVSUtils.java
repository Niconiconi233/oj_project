...
* @author: YW
*
* @create: 2020-04-23 13:49
**/

public class CVSUtils {
    private static Logger logger = LoggerFactory.getLogger(CVSUtils.class);
    ...
    public static File makeTempCSV(String fileName, String[] head, List<CSVEntity> values) throws IOException {
//        创建文件
...
//        写入内容
        for (CSVEntity value : values) {
            printer.printRecord(value.getUser(), value.getPassword());
        }
